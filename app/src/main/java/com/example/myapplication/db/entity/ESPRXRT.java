...
public class ESPRXRT extends BaseEntity {
    ...
    public ESPRXRT(Long sensorActuatorId, Integer sensorOrActuator, String variableName, String dataType, Integer numberOfChannels, List<ESPRXRTThreshold> thresholds, Integer deleted, Long createdAt) {
